      ...
      <div class='w-[24rem] h-[35rem] border rounded-lg sticky top-[90px]'>
        <div class='p-4'>
          <div class='flex items-center gap-3'>
            ...
            <div class='mb-2'>
              <div class='text-[1.05rem] font-semibold'>Mr John Doe</div>
              <div class='font-light text-sm'>johndoe@gmail.com</div>
            </div>
          </div>
          <div class='mt-8'>
            <div class='text-sm font-semibold'>Address</div>
            <div class='text-sm font-light'>{faker.location.streetAddress({useFullAddress: true})}</div>
          </div>
          <div class='mt-5'>
            <div class='text-sm font-semibold'>Phone</div>
            <div class='text-sm font-light'>09784983492</div>
          </div>
          <div class='mt-6'>
