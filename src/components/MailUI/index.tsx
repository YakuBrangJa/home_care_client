...
const MailUI = () => {
	...
	return (
    // <div class="overflow-hidden rounded-[0.5rem] border bg-background shadow-md md:shadow-xl w-[90%] mx-auto">
    <div>
				<Resizable sizes={sizes()} onSizesChange={setSizes}>
					...
					<ResizablePanel initialSize={sizes()[1] ?? 0.4} minSize={0.3}>
						<Tabs defaultValue="all" class="flex flex-col h-[100vh]">
							...
							<TabsContent value="all" class="m-0 flex-1 overflow-y-scroll">
								<MailList type="all" />
							</TabsContent>
            <TabsContent value="unread" class="m-0 flex-1 overflow-y-scroll">
