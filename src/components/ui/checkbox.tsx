  ...
  return (
    <>
      ...
      <CheckboxPrimitive.Control
        class={cn(
          "h-[1.1rem] w-[1.1rem] shrink-0 rounded-sm border border-gray-400 transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring data-[disabled]:cursor-not-allowed data-[checked]:bg-primary data-[checked]:text-primary-foreground data-[checked]:border-primary data-[disabled]:opacity-50",
          local.class,
        )}
        {...rest}
      >
