  ...
  return (
    ...
    >
      <SheetContent
        ...
        */}
        <div value="info" class="h-[calc(100%-3.35rem)] overflow-y-auto custom-scroll pb-5">
          ...
          */}
            ...
            <Show when={serviceData.managerInstruction}
              fallback={
                <p class=" text-[0.85rem] text-muted-foreground px-4 py-8 border rounded-xl leading-[1.35rem] text-center">No instruction from manager!</p>
              }
            >
              <p class="text-[0.85rem] text-muted-foreground px-4 py-3 border rounded-xl leading-[1.35rem]">{serviceData.managerInstruction}</p>
            </Show>
            </div>
